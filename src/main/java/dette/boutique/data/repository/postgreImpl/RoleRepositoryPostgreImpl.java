package dette.boutique.data.repository.postgreImpl;
...
public class RoleRepositoryPostgreImpl extends RepositoryDbImpl<Role> implements RoleRepository {

    RoleRepository roleRepository;

    public RoleRepositoryPostgreImpl(RoleRepository roleRepository) {
        this.tableName = "role";
        this.roleRepository = roleRepository;
    }

    private final String INSERT_QUERY = "INSERT INTO role (nom) VALUES (?)";
    private static final String SELECT_QUERY = "SELECT role.id AS role_id, role.nom AS role_nom FROM role";
